...
const JobApplicantsScreen: React.FC = () => {
    ...
    const handleMessageApplicant = async (applicant: Applicant & { workerId?: string }) => {
        ...
        try {
            ...
            conversationId = chatService.buildConversationId(jobId, user.id, applicant.workerId);
        }
    ...
    const updateApplicantStatus = async (
        ...
        try {
            ...
            await jobService.updateApplicationStatus(applicantId, status.toLowerCase() as any);
        } catch (error) {
